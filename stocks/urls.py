...
urlpatterns = [
    ...
    path('<int:stock_id>/', views.stock_item_details,
         name='stock_item_details'),
    path('create_item/', views.create_stock_item, name='create_stock_item'),
    path('edit_item/<int:stock_id>/', views.edit_stock_item,
         name='edit_stock_item'),
    path('receive_stock/', views.create_stock_receipt,
         name='create_stock_receipt'),
    path('receive_stock/item/<int:stock_id>/', views.create_item_stock_receipt,
         name='create_item_stock_receipt'),
    path('receive_stock/supplier/<int:supplier_id>/',
         views.create_supplier_stock_receipt,
         name='create_supplier_stock_receipt'),
    path('receive_stock/edit/<int:receipt_id>/', views.edit_stock_receipt,
         name='edit_stock_receipt'),
    path('transfer_stock/', views.create_stock_transfer,
    ...
    path('supplier/create/', views.create_supplier,
         name='create_supplier'),
    path('supplier/edit/<int:supplier_id>/', views.edit_supplier,
         name='edit_supplier'),
]
